...
function Header(props) {
    ...
    return (
        <header>
            <div className='logo'>
                <Link to="/"><img src={`${process.env.PUBLIC_URL}/assets/my-compilist-logo.svg`} alt='My Compilist site logo' height='30' /></Link>
            </div>
            <div className='username margin-top-extra-extra-large' style={{visibility: `${username ? 'visible': 'hidden'}`}}>
